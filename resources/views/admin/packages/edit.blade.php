                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.packages.update', $data['package']) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 col-md-6">
                                <input  class="form-control" name="name" id = "name" required
                                 value="{{$data['package']->name}}" autocomplete="on" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 col-md-6">
                                <input  class="form-control" name="hours" id = "hours" autocomplete="on" 
                                 value="{{$data['package']->hours}}" type="number" step="0.01" min="0">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 col-md-6 d-flex align-items-center">
                                <label class = "radio-inline mb-0">
                                    ...
                                    <?= $data['package']->prepaid == "1" ? "checked" : "" ?> required>&nbsp;Yes
                                </label> &nbsp; &nbsp;
                                <label class = "radio-inline mb-0">
                                    <input type="radio" name="prepaid" id="prepaid" value="0"
                                    <?= $data['package']->prepaid == "0" ? "checked" : "" ?> required>&nbsp;No
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class = "col-8 col-md-6">
                                ...
                                value="{{$data['package']->price_usa}}" autocomplete="on" autofocus type="number" step="0.01" min="0">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class = "col-8 col-md-6">
                                ...
                                value="{{$data['package']->price_can}}" autocomplete="on" autofocus type="number" step="0.01" min="0">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 col-md-6">
                                ...
                                value="{{$data['package']->price_alb}}" autocomplete="on" autofocus type="number" step="0.01" min="0">
                            </div>
                        </div>
