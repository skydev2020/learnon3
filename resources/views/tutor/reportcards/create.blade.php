        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-user-tie" style="font-size:24px;"> Tutor Progress Report</i>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('tutor.reportcards.store') }}">
                        @csrf
                        {{method_field('POST')}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6 d-flex align-items-center font-weight-bold">
                                <label class="radio-inline d-flex align-items-center">
                                    <input type="radio" name="student_prepared" value="1">&nbsp;Yes
                                </label>&nbsp;&nbsp;
                                <label class="radio-inline d-flex align-items-center">
                                    <input type="radio" name="student_prepared" value="0">&nbsp;No
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6 d-flex align-items-center font-weight-bold">
                                <label class="radio-inline d-flex align-items-center">
                                    <input type="radio" name="questions_ready" value="1">&nbsp;Yes
                                </label>&nbsp;&nbsp;
                                <label class="radio-inline d-flex align-items-center">
                                    <input type="radio" name="questions_ready" value="0">&nbsp;No
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6 d-flex align-items-center font-weight-bold">
                                <label class="radio-inline d-flex align-items-center">
                                    <input type="radio" name="pay_attention" value="1">&nbsp;Yes
                                </label>&nbsp;&nbsp;
                                <label class="radio-inline d-flex align-items-center">
                                    <input type="radio" name="pay_attention" value="0">&nbsp;No
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6 d-flex align-items-center font-weight-bold">
                                ...
                                class = "form-control inputstl"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6 d-flex align-items-center font-weight-bold">
                                <label class="radio-inline d-flex align-items-center">
                                    <input type="radio" name="listen_to_suggestions" value="1">&nbsp;Yes
                                </label>&nbsp;&nbsp;
                                <label class="radio-inline d-flex align-items-center">
                                    <input type="radio" name="listen_to_suggestions" value="0">&nbsp;No
                                </label>
                            </div>
                        </div>
