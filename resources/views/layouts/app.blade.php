                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        @auth
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item {{Request::segment(2)=="studentinvoices" ? 'active' : '' }}"
                                    href="{{route('admin.studentinvoices.index')}}">Student Invoices</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('register') }}">{{ __('Student Registration') }}</a>
                            </li>
                            @endif
                            @if (Route::has('register_tutor'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('register_tutor') }}">{{ __('Tutor Registration') }}</a>
                            </li>
                            @endif
                        @else
                            <li class="nav-item dropdown">
